 ...
 **********************************************************************************************/
	...
	this.reCalc = function()
		...
		// *** //		 		
		this.widjetObj.html(local.goods + " " + " " + " " + sum + " $"); // +num + and deleted + local.amount +
		localStorage.setItem(this.cardID, JSON.stringify(this.DATA));
		}
	...
	this.renderBasketTable = function()
		...
		if ($('#bcontainer').length == 0)
			...
			$("body").append(" \
				...
				<div id='bsubject'>" + local.basket + "<a id='bclose'  onclick='" + this.objNAME + ".closeWindow(\"bcontainer\", 1);'><img src='data:image/jpeg;base64,"+ this.IMG + "' /></a></div> \
		...
		for(var idkey in this.DATA) 
			...
			with (this.DATA[idkey])
				...
				var productLine = '<tr class="bitem" id="wigoodline-' + id + '"> \
													...
													<td id="lineprice_' + id + '"class="wigoodprice">' + price + ' usd.</td> \
													<td> \
													...
													<td id="linesum_' + id + '">'+ parseFloat(price * num) +' usd.</td> \
